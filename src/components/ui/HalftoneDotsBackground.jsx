...
const UNIFORMS = {
  colors: [[0.678431,0.156863,0.192157],[0.501961,0.054902,0.07451],[0.392157,0.05098,0.078431],[0.219608,0.015686,0.054902],[0.145098,0.035294,0.007843],[0.145098,0.035294,0.007843],[0.145098,0.035294,0.007843],[0.145098,0.035294,0.007843]],
  colorCount: 5,
  scale: 2.5,
  intensity: 1.08,
  paramA: 0.320,
...
export default function HalftoneDotsBackground({ className = "" }) {
  ...
  useEffect(() => {
    ...
    const resizeCanvas = () => {
      ...
      const pixelScale = Math.min(
        1,
        Math.sqrt(12_000_000 / Math.max(1, rawWidth * rawHeight)),
      )
  ...
  return (
    <canvas ref={canvasRef} className={`halftone-background `} aria-hidden="true" style={{ display: "block", width: "100%", height: "100%" }} />
  )
}
